...
abstract class $ScheduleModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(includeIfNull: false) String? id, String job});
}
...
class _$ScheduleModelImpl implements _ScheduleModel {
  const _$ScheduleModelImpl(
      {@JsonKey(includeIfNull: false) this.id, this.job = ''});
  ...
  @override
  String toString() {
    return 'ScheduleModel(id: $id, job: $job)';
  }
...
abstract class _ScheduleModel implements ScheduleModel {
  const factory _ScheduleModel(
      ...
      final String job}) = _$ScheduleModelImpl;
